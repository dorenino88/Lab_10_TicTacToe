...
public class SafeInput
{
    ...
    public static int getInt(Scanner pipe, String prompt)
    {
        ...
        do
        {
            ...
            {
                trash = pipe.nextLine();
                System.out.println("You must enter an a number: " + trash);
            }
        }while(!done);
    ...
    public static void prettyHeader(String msg)
    {
        ...
        int totalLength = 60 - 6 - msgLength;
        int leftSpace = totalLength/2;
        int rightSpace = totalLength - leftSpace - 1;
        ...
        System.out.println();
        System.out.print("***");
        for (int count = 0;count <= leftSpace;count++)
        {
            System.out.print(" ");
        }
        System.out.print(msg);
        for (int count = 0;count <= rightSpace;count++)
        {
            System.out.print(" ");
        }
        System.out.println("***");
